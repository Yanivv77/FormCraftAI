...
function FormUi({ jsonForm,selectedTheme,selectedStyle, 
  onFieldUpdate,deleteField,editable=true,formId=0,enabledSignIn=false }:any) {
  ...
  const hadleSelectChange=(name:string,value:any)=>{
    setFormData({
      ...formData,
      [name]:value
    })
  ...
  const handleCheckboxChange=(fieldName:string, itemName:string, value:any)=>{
